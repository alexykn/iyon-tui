...
export const generatedAbiCases: readonly GeneratedAbiBenchmarkCase[] = [
  ...
  { name: "view_status_detail", family: "diagnostic", hotness: "rare", benchmarkRegistration: "diagnostic.status_detail", scalarArgs: 1, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 0 },
  ...
  { name: "view_state_attach", family: "structural_patch", hotness: "warm", benchmarkRegistration: "view.state_attach", scalarArgs: 6, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
  { name: "view_content_host_create", family: "constructor", hotness: "warm", benchmarkRegistration: "view.content_host_create", scalarArgs: 5, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
  ...
  { name: "axis_builder_abort", family: "builder", hotness: "rare", benchmarkRegistration: "builder.axis_abort", scalarArgs: 2, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
  ...
  { name: "view_diff_create_buffer", family: "constructor", hotness: "warm", benchmarkRegistration: "view.diff_create_buffer", scalarArgs: 5, hasBuffer: true, maxBufferBytes: 1048576, maxInputCount: 262144 },
  { name: "view_hanging_create", family: "constructor", hotness: "warm", benchmarkRegistration: "view.hanging_create", scalarArgs: 6, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 3 },
  { name: "view_container_create", family: "constructor", hotness: "warm", benchmarkRegistration: "view.container_create", scalarArgs: 4, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
  { name: "view_clamp_create", family: "constructor", hotness: "warm", benchmarkRegistration: "view.clamp_create", scalarArgs: 8, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
  { name: "view_component_create", family: "constructor", hotness: "warm", benchmarkRegistration: "view.component_create", scalarArgs: 5, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 0 },
  { name: "view_decorated_create_buffer", family: "constructor", hotness: "warm", benchmarkRegistration: "view.decorated_create_buffer", scalarArgs: 7, hasBuffer: true, maxBufferBytes: 1048576, maxInputCount: 262144 },
  ...
  { name: "view_release_many", family: "lifecycle", hotness: "rare", benchmarkRegistration: "lifecycle.release_many", scalarArgs: 2, hasBuffer: true, maxBufferBytes: 524288, maxInputCount: 131072 },
  ...
  { name: "edit_txn_abort", family: "edit_transaction", hotness: "rare", benchmarkRegistration: "edit_txn.abort", scalarArgs: 2, hasBuffer: false, maxBufferBytes: 0, maxInputCount: 1 },
