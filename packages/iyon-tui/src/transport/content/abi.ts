...
export const CONTENT_ABI_MUTATION_RESULT_BYTES =
	CONTENT_ABI_MUTATION_RESULT_LANES * 4;
...
export const CONTENT_ABI_BUILD_FINGERPRINT = [
	0x494f_4e53, 0x362d_5445, 0x5854_2d31, 0, 0, 0, 0, 0,
] as const;
export const CONTENT_ABI_SCHEMA_FINGERPRINT = [
	0x5045_5246, 0x3133_2d47, 0x434f_4e54, 0x454e_542d, 0x4142_4931, 0, 0, 0,
] as const;
...
const statusNames: Readonly<Record<number, ContentStatusName>> =
	Object.fromEntries(
		Object.entries(CONTENT_STATUS).map(([name, code]) => [
			code,
			name as ContentStatusName,
		]),
	);

export function contentStatusName(
	status: number,
): ContentStatusName | undefined {
...
export function decodeContentAbiMetadata(
	lanes: Uint32Array,
): ContentAbiMetadata {
